  ...
  render: function() {
    return (
      <div>
        ...
        <form className='three columns' onSubmit={this.togglePurchased}><button className={this.props.item.purchased ? '' : 'button-primary'}>{this.props.item.purchased ? 'Unbuy' : 'Buy'}</button></form>
